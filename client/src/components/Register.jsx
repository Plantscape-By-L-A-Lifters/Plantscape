...
const Register = () => {
    ...
    const register = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post('http://localhost:10000/api/users/register', user);
    ...
    return (
        <div className="register-container"> {/* Apply the container class */}
            ...
            <form onSubmit={register}> {/* Use onSubmit for React forms */}
                <label>
                    Username:
                ...
                <label>
                    Password:
                    <input type="password" name="password" required /> {/* Added required */}
                </label>
